...
const Form = () => {
    ...
    return (
        <Paper className={classes.paper}>
            ...
            <TextField name="prerequisites" variant="outlined" placeholder="Preawedawdcad" label="Prerequisites" fullWidth value={courseData.PreReqs} onChange={(e) => setCourseData({ ...courseData, PreReqs: e.target.value })}/>
