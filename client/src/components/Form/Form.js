...
const Form = ({courseInformation}) => {
    ...
    const clear = () =>{
        setCourseData({DepartmentCode: '', CourseNumber: Number, CourseTitle: '', CourseDescription: '', MinimumGrade: '', CreditHours: Number, PreReqs: '', CoReqs: '', Term: Number});
    }
    ...
    return (
        <Paper className={classes.paper}>
            ...
            <TextField name="departmentcode" variant="outlined" label="Department Code" placeholder="Ex. CSC" fullWidth value={courseData.DepartmentCode} onChange={(e) => setCourseData({ ...courseData, DepartmentCode: e.target.value })}/>
            <TextField name="coursenumber" variant="outlined" label="Course Number" placeholder="Ex. 101" fullWidth value={courseData.CourseNumber} onChange={(e) => setCourseData({ ...courseData, CourseNumber: e.target.value })}/>
