...
const Form = ({courseInformation, updateCourseInfo}) => {
    ...
    return (
        <Paper className={classes.paper}>
            ...
            <TextField error={courseData.MinimumGrade === ""} inputProps={{ maxLength: 1 }} name="minimumgrade" variant="outlined" label="Minimum Grade" placeholder="Ex. C" fullWidth value={courseData.MinimumGrade} onChange={(e) => setCourseData({ ...courseData, MinimumGrade: e.target.value.split(" ").join("").toUpperCase() })}/>
